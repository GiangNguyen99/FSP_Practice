...
extern const timer_instance_t g_timer3_pwm;

/** Access the GPT instance using these structures when calling API functions directly (::p_api is not used). */
extern gpt_instance_ctrl_t g_timer3_pwm_ctrl;
extern const timer_cfg_t g_timer3_pwm_cfg;
